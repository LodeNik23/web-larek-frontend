...
```
## В файле modal.scss внесены изменения в базовую верстку
```
    Для более корректного отображения модальных окон с высотой "по содержимому".
    Обоснование изменения - ответ Ментора: "если исправить верстку будет супер" 
    Изменения внесены и старый код закоммичен. 
```
...
```
"id" - карточки товара "string"
"description" - описание товара "string"
"image"- изображение товара "string"
