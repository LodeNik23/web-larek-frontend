...
```
```
"getItemList"- Получить данные списока с сервера
"getItem" - Получить данные конкретного товара по id
"orderItems" - Отправить данные покупки и получить ответ.
```
